  ...
  linkGroups: [
    {
      ...
      links: [
        ...
        { label: "Plastic part production", href: "/capabilities/plastic-parts" },
        { label: "Additive manufacturing", href: "/capabilities/additive-manufacturing" },
        { label: "Vacuum casting", href: "/capabilities/vacuum-casting" },
        { label: "Fabrication", href: "/capabilities/fabrication" },
        { label: "Welding", href: "/capabilities/welding" },
        { label: "Contract assembly", href: "/capabilities/contract-assembly" },
      ],
    },
    {
      title: "COMPANY",
      links: [
        ...
        { label: "How SFG works", href: "/how-it-works" },
        { label: "Why us", href: "/why-us" },
        { label: "Profiles we partner with", href: "/profiles" },
        { label: "The innovators", href: "/innovators" },
